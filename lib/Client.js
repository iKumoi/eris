...
class Client extends EventEmitter {
    ...
    */
    deleteMessage(channelID, messageID, reason) {
        return this.requestHandler.request("DELETE", Endpoints.CHANNEL_MESSAGE(channelID, messageID), true, {
          ...
          console.log(`[${channelID}/${messageID}]`, err)
        });
    }
    ...
    */
    editMessage(channelID, messageID, content) {
        ...
        return this.requestHandler.request("PATCH", Endpoints.CHANNEL_MESSAGE(channelID, messageID), true, content, content.file).then((message) => new Message(message, this)).catch(err => {
          console.log(`[${channelID}/${messageID}]`, err)
        });
    }
