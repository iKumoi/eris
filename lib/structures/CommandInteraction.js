...
* @prop {Number} data.type The [command type](htt ps://discord.com/developers/docs/interactions/application-commands#application-command-object-application-command-types)
...
class CommandInteraction extends Interaction {
    ...
    */
    ...
    async reply(content, files) {
        await this.createMessage(content, files)
        return this
    }
    /**
    * Acknowledges the interaction with a defer response
